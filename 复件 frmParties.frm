   ...
   Begin MSComctlLib.ImageList IL1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParties.frx":030A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParties.frx":0464
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParties.frx":05BE
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParties.frx":0718
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParties.frx":0872
            Key             =   ""
         EndProperty
      EndProperty
   End
...
If MsgBox(PublicMsgs(1), vbYesNo + vbDefaultButton2 + vbInformation, PublicMsgs(0)) = vbYes Then
    ...
    If UCase(Parties(CurrentPartyID).strID) <> UCase(CurrentParty.strID) Then              '外引
        ChangeStrID Parties(CurrentPartyID).strID, CurrentParty.strID
    End If
...
If CustomActive Then
    ...
    CurrentParty.Stacks(LstTroops.SelectedItem.Index).Min = TxtMin.Text
End If
End Sub
